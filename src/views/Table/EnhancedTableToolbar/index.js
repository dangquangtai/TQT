              ...
              <Grid container justifyContent="flex-start" spacing={gridSpacing}>
                ...
                {buttonImportMaterialParts && (
                  <Grid style={{ marginLeft: '15px' }}>
                    <Button variant="contained" color={'primary'} onClick={handleImportMaterialsPartData}>
                      {buttonImportMaterialParts.text}
                    </Button>
                  </Grid>
                )}
                {buttonCreateMaterialRequisition && (
                ...
                {buttonCreateMaterialReport && (
                  <Grid item xs={6}>
                    <Button variant="contained" color={'primary'} onClick={handleCreate}>
                      {buttonCreateMaterialReport.text}
                    </Button>
                  </Grid>
                )}
                {buttonCreateProductionReport && (
                  <Grid item xs={6}>
                    <Button variant="contained" color={'primary'} onClick={handleCreate}>
                      {buttonCreateProductionReport.text}
                    </Button>
                  </Grid>
                )}
                {buttonCreateProductReport && (
                  <Grid item xs={6}>
                    <Button variant="contained" color={'primary'} onClick={handleCreate}>
                      {buttonCreateProductReport.text}
                    </Button>
                  </Grid>
                )}
                {buttonCreateContractReport && (
                  <Grid item xs={6}>
                    <Button variant="contained" color={'primary'} onClick={handleCreate}>
                      {buttonCreateContractReport.text}
                    </Button>
                  </Grid>
                )}
                {buttonExportMaterialInventory && (
                ...
                {buttonCreateProductRequisition && (
                  <Grid item>
                    <Button variant="contained" color={'primary'} onClick={handleCreate}>
                      {buttonCreateProductRequisition.text}
                    </Button>
                  </Grid>
                )}
                {buttonCreateProductReceived && (
                  <Grid item>
                    <Button variant="contained" color={'primary'} onClick={handleCreate}>
                      {buttonCreateProductReceived.text}
                    </Button>
                  </Grid>
                )}
              </Grid>
