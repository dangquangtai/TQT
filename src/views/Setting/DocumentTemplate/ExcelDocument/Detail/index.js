...
const TemplateDocumentModal = () => {
    ...
    const handleDownload = (e) => {
        if (excelDocumentTemplate.file_url) {
            downloadFile(excelDocumentTemplate.file_url);
        }
                                                        ...
                                                        <Grid item lg={12} md={12} xs={12}>
                                                            <div className={classes.tabItem}>
                                                                ...
                                                                <div className={`${classes.tabItemBody} ${classes.tabItemMentorAvatarBody}`}>
                                                                    <img src='https://firebasestorage.googleapis.com/v0/b/tqtapp-873d6.appspot.com/o/Icon%2FattachFile.png?alt=media&token=302df534-166e-4d48-bfec-f36cb9d93f67' alt="" />
                                                                    <div>
