...
export const getListSupplierFromMaterialCategoryForMaterialReport = (category_list) => {
  return axiosServices
    .post(apiEndpoints.get_list_supplier_from_list_material_category_for_contract_report, category_list)
    .then((response) => {
      if (response.status === 200 && response.data.return === 200) {
        return response.data.list;
      }
